...
def consultarLocalidad_1(localidad_consultada_1):
    ...
    localidad_buscada_1 = Localidades.query(f"LocNombre == '{localidad_consultada_1}'")
    ...
    zonificaciongeotecnica_Localidad=zonificaciongeotecnica_Localidad.set_index("GEOTECNIA")
...
zonificacionGeotecnica = dbc.Container(
    [
       ...
       html.Hr(),
       html.Div([
           dcc.Dropdown(Localidades['LocNombre'].unique(), 'CIUDAD BOLIVAR' , id='localidad_consultada_1',
